...
const ENTRIES: Entry[] = [
  ...
  },
  {
    id: "habit-fail",
    category: "習慣形成",
    title: "習慣化に失敗する5つのパターン",
    excerpt: "意志ではなく、設計の問題。",
    body: "①目標のハードルが高すぎる → 脳は『大きな変化』を脅威と認識し、抵抗します。最初の一歩は「ばかばかしいほど小さく」。② ゴールが曖昧 → 『健康になる』ではなく『22時に歯を磨く』のように行動レベルまで分解。③ 完璧主義 → 一度の失敗で全てを諦める『what-the-hell効果』を回避するため、80点で継続する設計に。④ やる理由が弱い → 感情と結びつかない目標は脳が優先しない。『未来の自分』『大切な人』と結びつけ直す。⑤ 自己否定が強い → 失敗時の罰が大きいほど、行動から逃げるようになる。観察と自己慈悲が習慣を守る鍵です。",
    evidence: "Wood W. (2019) Good Habits, Bad Habits. Farrar, Straus and Giroux.",
  },
  {
    id: "habit-period",
    category: "習慣形成",
    title: "習慣が定着するまでの期間",
    excerpt: "1ヶ月・3ヶ月・6ヶ月。種類で違う。",
    body: "行動習慣（約1ヶ月） — 読書・片付け・日記など『やるかやらないか』の小さな行動。大脳基底核に行動パターンが刻まれるまで約3〜4週間。\n\n身体習慣（約3ヶ月） — ダイエット・禁煙・運動など、生理機能の変化を伴うもの。ホルモン分泌や代謝の再調整に時間が必要。\n\n思考習慣（約6ヶ月） — ネガティブ思考の修正、完璧主義の改善、自己否定の緩和。神経回路（とくに前頭前野と扁桃体の連絡）が再配線されるまでに最も長い期間がかかる。\n\nコツは『種類の違いを知って、焦らないこと』。期待値のズレが、最大の挫折要因です。",
    evidence: "Lally et al. (2010) How are habits formed. European Journal of Social Psychology — 平均66日、種類で大きく分散。",
  },
  {
    id: "habit-3stages",
    category: "習慣形成",
    title: "習慣化の3段階 — 反発期・不安定期・倦怠期",
    excerpt: "壁の正体を知れば、乗り越えられる。",
    body: "① 反発期（1〜7日） — 『やりたくない』『元に戻りたい』。脳は変化をエネルギーコストと見なし、ホメオスタシス（恒常性）で抵抗します。乗り越え方：とにかく小さく。『1分だけ』『1ページだけ』で十分。\n\n② 不安定期（8〜21日） — 『できる日とできない日がある』。スケジュールの乱れに弱い時期。乗り越え方：if-thenプラン（『もし朝起きたら、コップ一杯の水を飲む』）で行動を環境に紐付ける。\n\n③ 倦怠期（22日以降） — 『飽きた』『意味を感じなくなる』。脳が行動に慣れ、ドーパミンが減少。乗り越え方：少しだけ変化を加える（場所を変える・記録方法を変える・人に話す）。新鮮さが報酬系を再点火します。",
    evidence: "古川武士 (2010)『30日で人生を変える「続ける」習慣』— 反発期・不安定期・倦怠期のモデル。",
  },
];
